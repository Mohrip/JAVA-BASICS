...
public class conditions {
    public static void main(String[] args) {
        ...
        if (String.valueOf(MyName).equals("Mohammed")) {
            System.out.println("Mohammed is Mohammed");
        } else if (String.valueOf(MyName).equals("")) {
            System.out.println("My name is empty");
        }
